public class Lista {
    ...
    public Computer visita() {
        ...
        Computer valore = cursor.value;
        cursor = cursor.next;
        return valore;
    }

    public Computer lettura(int indice) {
        Nodo temp = head;
        int i = 0;
    ...
    public void inserimento(Computer valore, int indice) {
    ...
    public void accodamento(Computer valore) {
        Nodo nuovo = new Nodo(valore, null);
    ...
    public void aggiungiOrdinatoPerRAM(Computer valore) {
        Nodo nuovo = new Nodo(valore, null);
